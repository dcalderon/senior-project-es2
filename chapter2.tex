...
Notice that the two clades are totally free from each other's periodic selection diversity quashing.
This is an important feature of separate ecotypes.

Theory dictates that these boundaries correlate to ecological niche.
To identify the fundamental elements takes three steps.
...
Since the two clades are evolving independently we can use the molecular clock characteristic of specific ubiquitous genes.
