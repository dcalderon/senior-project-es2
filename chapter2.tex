...
Success is determined by whether or not these two lines match with the pre-determined factor of closeness.
...
Using Bruteforce output we find a range of likely parameters which we then pass through an optimization program known as Hillclimbing (see Figure \ref{fig:Flow}b). 
