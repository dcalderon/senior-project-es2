...
With the most likely estimations of $npop$, $\sigma$, and $\Omega$ (remember that we stop discussing drift since it occurs rarely), we proceed to the demarcation (see Figure \ref{fig:Flow}C on page~\pageref{fig:Flow}) step of ES.
