...
Think of a node that represents each input organism and sequence from the present time (i.e., number of nodes equals number of input sequences), and the ancestral lineage of these organisms coalesce (due to PS or EF; indicated by gray circles in Figure \ref{fig:SpeciationGraph} on page~\pageref{fig:SpeciationGraph}) as ES steps backward in time.
