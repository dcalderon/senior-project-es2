...
Also, notice that once again ES2 has the lowest standard deviation, meaning that it was the most consistent, except of course for the random demarcation, which was consistently terrible.
...
I gave a survey of other available demarcation programs (\index{GMYC}, \index{BAPS}, \index{AdaptML}, \index{Random Demarcator}), how we generated sample datasets, and described the metric used to compare the various outputs (Variation of Information metric).
