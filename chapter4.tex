...
Figure~\ref{fig:All100} on page~\pageref{fig:All100} shows accuracy scores for all demarcating programs on a variety of parameters (\emph{Bacillus} values with $\frac{1}{10x}$ and 10x and $npop$ values of 30, 40, 50) on sample size of 100 individuals.
