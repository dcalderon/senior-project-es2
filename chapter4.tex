...
I quickly developed a random demarcator to serve as a control. In it I pick a random number between one and the number of samples for $npop$, then I randomly distribute the generated sequences throughout $npop$ ecotypes. [USE BROKEN STICK RANDOM DEMARCATION]
