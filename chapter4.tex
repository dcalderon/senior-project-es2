...
%Added to the extras in the appendix
%\begin{figure}[h!]
%  \centering
...
%    \end{tabular}
%    \caption[Statistics on all demarcators on $nu=100$.]{Statistics on all demarcators run with 5 reps on a dataset of $nu=50$.}
